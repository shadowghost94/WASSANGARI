...
class Utilisateur(models.Model):
    ...
    numero_momo = models.CharField(max_length=255, blank=True)
    num_carte_paiement = models.CharField(max_length=255, blank=True)
    media_profil_url = models.ImageField(default="default.jpg", upload_to="user_images")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    password = models.CharField(max_length=255)
    sites_visites = models.ManyToManyField(SiteHistorique, blank=True)
    monuments_visites = models.ManyToManyField(Monument, blank=True)
    parcs_visites = models.ManyToManyField(ParcNational, blank=True)
    reserves_visites = models.ManyToManyField(Reserve, blank=True)
    musees_visites = models.ManyToManyField(Musee, blank=True)

...
class SiteHistorique(models.Model):
    ...
    media_profil_url = models.ImageField(upload_to='siteHistorique/', null=True, blank=True)
    description = models.TextField()
    histoire = models.TextField(null=True)
...
class Monument(models.Model):
    ...
    description = models.TextField()
    media_profil_url = models.ImageField(upload_to='Monument/', null=True, blank=True)
    histoire = models.TextField(null=True)
    visiteurs_annuels = models.IntegerField()
    horaires = models.CharField(max_length=255)
    prix_entree = models.DecimalField(max_digits=10, decimal_places=2)
...
class ParcNational(models.Model):
    ...
    localisation = models.CharField(max_length=255)
    description = models.TextField()
    media_profil_url = models.ImageField(upload_to='ParcNational/', null=True, blank=True)
    visiteurs_annuels = models.IntegerField()
    organisme_gestion = models.CharField(max_length=255)
...
class Reserve(models.Model):
    ...
    localisation = models.CharField(max_length=255)
    description = models.TextField()
    media_profil_url = models.ImageField(upload_to='Reserve/', null=True, blank=True)
    visiteurs_annuels = models.IntegerField()
    organisme_gestion = models.CharField(max_length=255)
    superficie = models.FloatField()
    horaires = models.CharField(max_length=255)
...
class Musee(models.Model):
    ...
    localisation = models.CharField(max_length=255)
    description = models.TextField()
    media_profil_url = models.ImageField(upload_to='Musee/', null=True, blank=True)
    prix_entree = models.DecimalField(max_digits=10, decimal_places=2)
...
class ContenuMultimedia(models.Model):
    ...
    type = models.CharField(max_length=10, choices=TYPE_CHOICES)
    media_url = models.FileField(upload_to='multimedia/', null=True, blank=True)
